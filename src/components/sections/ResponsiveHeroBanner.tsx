...
const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
    ...
    backgroundImageUrl = "https://images.unsplash.com/photo-1610984164139-44670046524f?q=80&w=1974&auto=format&fit=crop",
    navLinks = [
    ...
    badgeLabel = "New",
    badgeText = "Sustainably Crafted Banana Fiber Products",
    title = "Journey Beyond Waste",
    titleLine2 = "Into Regeneration",
    description = "Experience the future of sustainable materials. Our advanced banana fiber technology makes eco-friendly living accessible, beautiful, and impactful.",
    primaryButtonText = "Explore Products",
    primaryButtonHref = "/products",
    secondaryButtonText = "Our Story",
    secondaryButtonHref = "/about",
    partnersTitle = "Partnering with leading environmental agencies worldwide",
    partners = [
    ...
    return (
        <section className="w-full isolate min-h-screen overflow-hidden relative">
            ...
            <div className="pointer-events-none absolute inset-0 ring-1 ring-black/30 z-10" />
