...
export const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
    ...
    badgeLabel = "New",
    badgeText = "Sustainable Banana Fiber Collection 2026",
    title = "Crafting a Greener Future",
    titleLine2 = "With Banana Fiber",
    description = "Transforming agricultural waste into high-quality, sustainable materials. Join us in our journey towards a circular economy and community empowerment.",
    primaryButtonText = "Explore Products",
    primaryButtonHref = "/products",
    secondaryButtonText = "Our Story",
    secondaryButtonHref = "/about",
    partnersTitle = "Partnering with leading organizations worldwide",
    partners = [
            ...
            <header className="z-20 xl:top-4 relative">
                <div className="mx-6">
                    <div className="flex items-center justify-between pt-4">
                        <a
                            href="/"
                            className="inline-flex items-center justify-center bg-center w-[100px] h-[40px] bg-contain bg-no-repeat rounded"
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 animate-fade-slide-in-2 text-white/70 mt-6 items-center justify-items-center gap-4">
                            {partners.map((partner, index) => (
                                <a
                                    key={index}
                                    href={partner.href}
                                    className="inline-flex items-center justify-center bg-center w-[120px] h-[36px] bg-contain bg-no-repeat opacity-80 hover:opacity-100 transition-opacity"
