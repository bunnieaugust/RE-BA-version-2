    ...
    <section className="py-32">
      <div className="container px-4 mx-auto">
        <div className="mx-auto max-w-3xl">
          <h1 className="mb-4 text-3xl font-bold tracking-tight md:text-5xl text-brand-charcoal">
            {title}
          </h1>
          <p className="mb-6 text-base text-brand-charcoal/70 md:text-lg">
            {description}
          </p>
        </div>
              ...
              >
                ...
                <div className="top-8 flex h-min w-64 shrink-0 items-center gap-4 md:sticky">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg transition-colors duration-300 ${
                      isActive ? "bg-brand-green text-white" : "bg-brand-ivory text-brand-charcoal/50"
                    }`}>
                ...
                <article
                  className={
                    ...
                    (isActive
                      ? "border-brand-green/20 bg-brand-ivory dark:bg-brand-olive shadow-lg"
                      : "border-brand-charcoal/10 bg-white dark:bg-brand-charcoal/10")
                  }
                >
                  {entry.image && (
                    <img
                    ...
                    <div className="space-y-2">
                      <h2
                        className={
                          ...
                          (isActive ? "text-brand-charcoal" : "text-brand-charcoal/70")
                        }
                      >
                        {entry.title}
                      </h2>
                      ...
                      <p
                        className={
                          ...
                          (isActive 
                            ? "text-brand-charcoal/70 line-clamp-none" 
                            : "text-brand-charcoal/50 line-clamp-2")
                        }
                      >
                        {entry.description}
                      </p>
                      ...
                      <div className="overflow-hidden">
                        <div className="space-y-4 pt-2">
                          {entry.items && entry.items.length > 0 && (
                            <div className="rounded-lg border border-brand-charcoal/10 bg-white p-4">
                          ...
                          {entry.button && (
                            <div className="flex justify-end">
                              <Button 
                                variant="default" 
                                size="sm"
                                className="group bg-brand-green hover:bg-brand-green-light text-white font-normal transition-all duration-200 rounded-full" 
                                asChild
                              >
